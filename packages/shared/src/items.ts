...
export const ITEM_TEMPLATES: ItemTemplate[] = [
  ...
  { id: 'spyglass', name: 'Spyglass', baseSpriteId: '167', baseValue: 5, materials: ['Used'], rarities: ['Common'], effectType: 'revealBidding', flatValue: true, traits: [] },
  { id: 'treasure-chest', name: 'Treasure Chest', baseSpriteId: '187', baseValue: 0, materials: ['Used'], rarities: ['Common'], effectType: 'chest', flatValue: true, traits: [], chest: { keyTemplateId: 'rusty-key', grantsTraitId: 'trinket', grantsCountRange: [1, 3] } },
  { id: 'sunken-treasure-chest', name: 'Sunken Treasure Chest', baseSpriteId: '270', baseValue: 0, materials: ['Used'], rarities: ['Common'], effectType: 'chest', flatValue: true, traits: [], chest: { keyTemplateId: 'rusty-key', grantsTraitId: 'aquatic', grantsCountRange: [3, 5] } },
  { id: 'rusty-key', name: 'Rusty Key', baseSpriteId: '185', baseValue: 1, materials: ['Used'], rarities: ['Common'], effectType: 'key', flatValue: true, traits: [] },
  { id: 'chronomancers-hourglass', name: "Chronomancer's Hourglass", baseSpriteId: '352', baseValue: 0, materials: ['Used'], rarities: ['Common'], effectType: 'refundOnLoss', flatValue: true, traits: ['magic'] },
  { id: 'mirror-of-desire', name: 'Mirror of Desire', baseSpriteId: '177', baseValue: 5, materials: ['Used'], rarities: ['Common'], effectType: 'copyItem', flatValue: true, traits: [] },
  { id: 'contraband-permit', name: 'Contraband Permit', baseSpriteId: '218', baseValue: 5, materials: ['Used'], rarities: ['Common'], effectType: 'weaponMultiplier', flatValue: true, traits: [] },
];
