...
export const CLASS_DEFINITIONS: ClassDefinition[] = [
  ...
  { id: 'jeweller', name: 'Jeweller', description: 'Trinkets you own count toward a small set bonus.', color: '#c98a3f', portraitIndex: 56 },
  ...
  { id: 'fence', name: 'Fence', description: 'Cursed items you win are never discounted for being cursed.', color: '#b5b54a', portraitIndex: 139 },
